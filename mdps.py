...
diabetes_model = pickle.load(open('D:/Machine Learning/MultipleDisease Predictive System/Saved Models/diabetic_model.sav', 'rb'))
hearts_model = pickle.load(open('D:/Machine Learning/MultipleDisease Predictive System/Saved Models/heart_model.sav', 'rb'))
